...
cd "$WEB_DIR"
NODE_TLS_REJECT_UNAUTHORIZED=0 npx next dev --port 3002 &
NEXT_PID=$!
...
echo "  -> Watching http://localhost:3002/api/inngest for functions"
...
echo ""
echo "NEXT STEP: Open http://localhost:3002/sign-in"
