...
import { personalizationBacktest } from "@/inngest/personalization-backtest";
...
export const { GET, POST, PUT } = serve({
  ...
  functions: [
    ...
    weeklyEvalHarness,
    // P1-12: nightly reply-rate back-test of the quality score — 03:00 UTC.
    personalizationBacktest,
